...
<div x-data="notificationBell()" class="<?php echo e($class); ?>">
    <!-- Кнопка уведомлений -->
    <button 
    ...
    >
        ...
        <div class="px-4 py-3 border-t border-gray-200 dark:border-gray-700">
            <a 
                href="<?php echo e(route('user.chat.index')); ?>" 
...
function notificationBell() {
    return {
        ...
        async loadNotifications() {
            try {
                const response = await fetch('<?php echo e(route("user.notifications")); ?>');
        ...
        async markAllAsRead() {
            try {
                const response = await fetch('<?php echo e(route("user.notifications.mark-all-read")); ?>', {
                    method: 'POST',
                    headers: {
...
<?php /**PATH /home/zendarol/akzholpharm/corporate-chat/resources/views/components/notifications/notification-bell.blade.php ENDPATH**/ ?>